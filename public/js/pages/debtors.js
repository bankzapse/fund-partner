      ...
      table(
        ...
        d.payments.map((p) =>
          el(
            ...
            el('td', { class: 'num' }, ['flat_total', 'deduct_upfront'].includes(p.contract_interest_mode) ? '—' : baht(p.interest_amount)),
            el('td', { class: 'num' }, ['flat_total', 'deduct_upfront'].includes(p.contract_interest_mode) ? '—' : baht(p.principal_amount)),
